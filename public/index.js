...
function insertNewTwit(twit_text, twit_auther) {

    const templateContext = { twit_body: twit_text, twit_auther: twit_auther }

    const twit_HTML = Handlebars.templates.twit(templateContext)

    const twit_con = document.getElementsByClassName('twit-container');
    twit_con[0].insertAdjacentHTML('beforeend', twit_HTML)
};
